 ...
 *
 */
package com.matthew.cn.newsreading.weiget;
...
public class URLImageGetter implements Html.ImageGetter {
    ...
    private static final String mFilePath = NewsApplication.getAppContext().getCacheDir().getAbsolutePath();
    ...
    private Drawable createPicPlaceholder() {
        ...
        drawable = new ColorDrawable(NewsApplication.getAppContext().getResources().getColor(color));
